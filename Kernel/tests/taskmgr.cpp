...
{
	while (1)
		TaskManager->Sleep((1000000 * 1'000'000ULL));
}
...
uint64_t GetUsage(uint64_t OldSystemTime, Tasking::TaskInfo *Info)
{
	...
	{
		uint64_t SystemTime = GlobalClock->Now() - OldSystemTime;
...
#warning "aarch64 not implemented"
		...
		TaskManager->Sleep((100 * 1'000'000ULL));
	}
}
